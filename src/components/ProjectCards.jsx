...
const ProjectCard = ({ title, description, image, technologies, link }) => {
  ...
  const CardContent = () => (
    <div className="flex flex-col h-full bg-[rgb(var(--color-bg)/0.6)] text-[var(--generic-2)] p-4 rounded shadow hover:shadow-lg transition-shadow duration-300 cursor-pointer hover:bg-[var(--transparent-bg)] hover:text-[var(--natural-4)]">

...
export default function ChatBot() {
  ...
  return (
    <Draggable nodeRef={nodeRef} cancel=".no-drag">
      <div
        ref={nodeRef}
        className="fixed bottom-4 left-70 bg-gray-900 text-white rounded shadow-lg flex flex-col overflow-hidden
      ...
      >
        ...
        <div
          ...
          className="flex-1 overflow-y-auto p-2 space-y-2 no-drag"
          aria-live="polite"
        >
          {messages.map((msg, i) => (
            <div
        ...
        <form
          onSubmit={handleSend}
          className="flex gap-2 p-2 border-t border-gray-700 no-drag"
        >
          <input
            type="text"
            value={input}
            ...
            className="flex-1 px-3 py-2 rounded text-black focus:outline-none"
          />
